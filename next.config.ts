...
const nextConfig: NextConfig = {
  ...
  images: {
    domains: [
      ...
      "cdn.pixabay.com",
      "res.cloudinary.com",
      // dodaj ovdje sve domene sa kojih koristiš slike
    ],
  },

  eslint: {
    ignoreDuringBuilds: true, // build pada ako postoje ESLint greške
  },
  ...
  experimental: {
    ...
    serverActions: true, // ako koristiš Next 14 server actions
  },
};
